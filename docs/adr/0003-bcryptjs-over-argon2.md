...
**Status:** accepted — **not yet implemented**, tracked in #4.

> Until #4 lands, passwords are stored in plain text and no hashing library is installed. This ADR records the decision, not the state of the code.
